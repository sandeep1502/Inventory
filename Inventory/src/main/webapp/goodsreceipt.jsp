...
<%@page  import="com.inventory.GoodsModel" %>
	   ...
	   <div class="inner-content">
		<!-- header-starts -->
			<div class="header-section">
				...
				<!--outter-wp-->
                                 <jsp:useBean id="Goodsbean" scope="session" class="com.inventory.GoodsModel" />
							<div class="outter-wp">
                                                            <h1 align=center style="color:#021F4E;">Goods are added Successfully </h1>
								...
								<div class="graph">
									<div class="tables">
                                                                            <table class="table table-hover">
                                                                               ...
                                                                               <tbody>
                                                                                    <tr>
                                                                                       <td><jsp:getProperty name="Goodsbean" property="grantid" /> </td>
                                                                                       <td><jsp:getProperty name="Goodsbean" property="grantvnid" /></td>
                                                                                       <td><jsp:getProperty name="Goodsbean" property="invoiceno" /></td>
                                                                                       <td><jsp:getProperty name="Goodsbean" property="grantdate" /> </td>
                                                                                       <td> <jsp:getProperty name="Goodsbean" property="total" /></td>
                                                                                    </tr>
                                                                                </tbody> 
                                                                            </table>
                                                             ...
                                                             <div class="graph-visual tables-main">
                                                                 <h2 style="color:#052963;"> Goods details</h2>
								<div class="graph">
                                                                            ...
                                                                            <table class="table table-hover" name="IssueBean_items">
                                                                               ...
                                                                               <tbody>
                                                                                    <c:forEach items="${Goodsbean.goods}"  var="gds">
                                                                                        <tr>

                                                                                            <td>  ${gds.productid} </td>
                                                                                            <td>  ${gds.prodbatchno}</td>
                                                                                             <td> ${gds.productqty}</td>
                                                                                             <td> ${gds.manuf}</td>
                                                                                             <td> ${gds.gst}</td>
                                                                                             <td> ${gds.amt}</td>
