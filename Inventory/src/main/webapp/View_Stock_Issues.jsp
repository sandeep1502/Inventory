			...
			<div class="header-section">
				 ...
				 <!--outter-wp-->
							<div class="outter-wp">
								...
								<h3 class="inner-tittle two">Stock Issues</h3>
                                                                    <div class="graph">
									<div class="tables">
                                                                            <table class="table table-hover">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th scope="col">Issues_Id</th>
                                                                                        <th scope="col">Issues_Indents_id</th>
                                                                                        <th scope="col">Issues_Date</th>
                                                                                        <th scope="col">Issues_Amount</th>
                                                                                     </tr>
                                                                                </thead>
            ...
            <%  
                                                    ...
                                                    try
                                                     ...
                                                     Connection con=DriverManager.getConnection(dc.getUrl(),dc.getUser(),dc.getPassword());
                                                            PreparedStatement ps=con.prepareStatement("Select * from STOCKISSUES");
