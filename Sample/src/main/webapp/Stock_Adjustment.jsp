											...
											<!--/set-2-->
												<div class="set-1">
													<div class="graph-2 general">
														<h3 class="inner-tittle two">Stock Adjustments Forms</h3>
															<div class="grid-1">
																<div class="form-body">
																	<form class="form-horizontal">
																		<div class="form-group">
																			<label for="focusedinput" class="col-sm-2 control-label">Item_Id</label>
																				<div class="col-sm-6">
																					<input type="text" class="form-control1" id="id" placeholder="Item_Id">
                                                                                                                                                                </div>
                                                                                                                                                ...
                                                                                                                                                <div class="form-group">
                                                                                                                                                            <label for="focusedinput" class="col-sm-2 control-label">Item_BatchNo</label>
                                                                                                                                                                    <div class="col-sm-6">
                                                                                                                                                                            <input type="text" class="form-control1" id="batchno" placeholder="Item_BatchNo">
                                                                                                                                                                    </div>
                                                                                                                                                                    
                                                                                                                                                </div>
                                                                                                                                                <div class="form-group">
																			<label for="focusedinput" class="col-sm-2 control-label">Defected_Quantity</label>
																				<div class="col-sm-6">
																					<input type="text" class="form-control1" id="qty" placeholder="Defected_Quantity">
                                                                                                                                                                </div>
                                                                                                                                                </div>
                                                                                                                                                                <div class="form-group">
																			                   <label for="focusedinput" class="col-sm-2 control-label">Reason</label>
																				                  <div class="col-sm-10">
																					                  <input type="text" class="form-control1" id="reason" placeholder="Reason">
                                                                                                                                                                                  </div>
																		</div>
                                                                                                                                                                            <p class="four">
																			<input type="button" class="a_demo_four" id="bt" value="SUBMIT" onclick="fun()" />
                                    ...
                                    function fun()
                                                {
                                                    ...
                                                    var b=document.getElementById("batchno").value;
                                                    ...
                                                    xhttp.onreadystatechange = function() 
                                                        {
                                                            if (this.readyState == '4' && this.status == '200')
                                                            {
                                                                ...
                                                                u=xhttp.responseText;
                                                                alert(u);
                                                                window.location.href="Live_Item_Stock.jsp"; 
                                                             }
                                                        };
                                                    xhttp.open("GET", "/Inventory/StockAdjustment?id="+a+"&batchno="+b+"&qty="+c+"&reason="+d, true);
                                                    xhttp.send();
                                                }
