			...
			<div class="header-section">
				...
				<!--outter-wp-->
							<div class="outter-wp">
								...
								<h3 class="inner-tittle two">Item Type</h3>
                                                                    <div class="graph">
									<div class="tables">
                                                                            <table class="table table-hover">
                                                                                <thead>
                                                                                    <tr>
                                                                                        ...
                                                                                        <th scope="col">Item_Type_Description</th>
                                                    ...
                                                    try
                                                     ...
                                                     Connection con=DriverManager.getConnection(dc.getUrl(),dc.getUser(),dc.getPassword());
                                                            PreparedStatement ps=con.prepareStatement("Select * from items_types");
                    ...
                    <!--//outer-wp-->
																		...
																		<div class="form-group">
																			<label for="focusedinput" class="col-sm-5 control-label">Item_Id</label>
																				<div class="col-sm-6">
                                                                                                                                                ...
                                                                                                                                                <div class="form-group">
                                                                                                                                                            <label for="focusedinput" class="col-sm-5 control-label">Item_Type_Name</label>
                                                                                                                                                                    <div class="col-sm-6">
                                                                                                                                                                            <input type="text" class="form-control1" id="Item_Type_Namee" placeholder="Item_Type_Name">
                                                                                                                                                                    </div>
                                                                                                                                                                    
                                                                                                                                                </div>
                                                                                                                                                <div class="form-group">
																			<label for="focusedinput" class="col-sm-5 control-label">Item_Type_Description</label>
																				<div class="col-sm-6">
																					<input type="text" class="form-control1" id="Item_Type_Descriptione" placeholder="Item_Type_Description">
                                                                                                                                                                </div>
                                                                                                                                                </div>
                                                                                                                                                        <p class="four">
                     ...
                     <script>
...

                        {
                                                           ...
                                                           if(u.localeCompare(k)==0)
                                                                {
                                                                      ...
                                                                      window.location.href="Item_Type.jsp";
                                                                  }
                                                           else
                                                                {
                            ...
                            req.open("GET","/Inventory/DeleteItemType?id="+i,true);
                            req.send(null);
                              ...
                              function edit()
                                        {
                                                ...
                                                var j = document.getElementById("Item_Type_Namee").value;
                                                var k = document.getElementById("Item_Type_Descriptione").value;
                                                ...
                                                req.open("GET","/Inventory/EditItemType?Item_Id="+i+"&Item_Type_Name="+j+"&Item_Type_Description="+k,true);
                                                req.send(null);
																			...
																			<label for="focusedinput" class="col-sm-2 control-label">Item_Id</label>
																				<div class="col-sm-6">
																					<input type="text" class="form-control1" id="Item_Id" placeholder="Item_Id">
                                                                                                                                                ...
                                                                                                                                                <div class="form-group">
                                                                                                                                                            <label for="focusedinput" class="col-sm-2 control-label">Item_Type_Name</label>
                                                                                                                                                                    <div class="col-sm-6">
                                                                                                                                                                            <input type="text" class="form-control1" id="Item_Type_Name" placeholder="Item_Type_Name">
                                                                                                                                                                    </div>
                                                                                                                                                                    
                                                                                                                                                </div>
                                                                                                                                                <div class="form-group">
																			<label for="focusedinput" class="col-sm-2 control-label">Item_Type_Description</label>
																				<div class="col-sm-6">
																					<input type="text" class="form-control1" id="Item_Type_Description" placeholder="Item_Type_Description">
                                                                                                                                                                </div>
                                                                                                                                                </div>
                                                                                                                                                        <p class="four">
                              ...
                              function add1()
                                        {
                                                ...
                                                var j = document.getElementById("Item_Type_Name").value;
                                                var k = document.getElementById("Item_Type_Description").value;
                                                ...
                                                req.open("GET","/Inventory/AddItemType?Item_Id="+i+"&Item_Type_Name="+j+"&Item_Type_Description="+k,true);
                                                req.send(null);
